...
use Tadcka\Bundle\SitemapBundle\Model\Manager\NodeSeoMetadataManager as BaseNodeSeoMetadataManager;

/**
 * @author Tadas Gliaubicas <tadcka89@gmail.com>
 */
class NodeSeoMetadataManager extends BaseNodeSeoMetadataManager
{
    ...
    {
        $this->em->persist($nodeSeoMetadata);
        if (true === $save) {
            $this->save();
        }
    }
    ...
    {
        $this->em->remove($nodeSeoMetadata);
        if (true === $save) {
            $this->save();
        }
    }
